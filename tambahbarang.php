...
if (isset($_POST["kirim"])) {
    $koneksi->query("INSERT INTO barang(nama_barang,stok_barang,ukuran_barang,id_satuan_barang,harga_barang) VALUES ('$_POST[nama]', '$_POST[stok]', '$_POST[ukuran]','$_POST[id_satuan]', $_POST[harga])");
